            ...
            >
              <div className='flex gap-4'>
                <div>
                  ...
                  <input
                    ...
                    id='firstName'
                    name='firstName'
                    className='shadow-sm bg-white border border-gray-300 text-black text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 focus:ring-primary-500 focus:border-primary-500 shadow-sm-light'
                    placeholder=''
              ...
              <div>
                ...
                <input
                  ...
                  id='subject'
                  name='subject'
                  className='block p-3 w-full text-sm text-black bg-white rounded-lg border border-gray-300 shadow-sm focus:ring-primary-500 focus:border-primary-500 focus:ring-primary-500 focus:border-primary-500 shadow-sm-light'
              ...
              <div>
                ...
                <textarea
                  ...
                  id='message'
                  rows={6}
                  className='block p-2.5 w-full text-sm text-black bg-white rounded-lg shadow-sm border border-gray-300 focus:ring-primary-500 focus:border-primary-500 focus:ring-primary-500 focus:border-primary-500'
